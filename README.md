...
> Uma calculadora desenvolvida com react-native.

Esse aplicativo desenvolvido com react-native permite o cálculo das 4 operações básicas (adição, subtração, multiplicação e divisão). Possui também os botões "AC" que limpa a tela e as operações, "=" que exibe o resultado final da operação e "." para números fracionados.

![](./screenshots/Screenshot_1589312442.png)
